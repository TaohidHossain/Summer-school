        ...
        <>
            ...
            <footer className="footer px-10 py-4 border-t bg-neutral text-neutral-content border-base-300">
                <div className="items-center grid-flow-col">
                    <img className="h-16" src="https://cdn.dribbble.com/users/635128/screenshots/1693908/media/ed1123055175d85e52468d7e1fe4efd6.jpg?compress=1&resize=400x300&vertical=top"/>
                    <p>Kobayashi<br />Providing reliable extra curricular studies since 1992</p>
                </div>
